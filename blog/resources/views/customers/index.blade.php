                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <a href="{{URL::route('customer.create')}}" class="btn green"><i class="fa fa-plus"></i> Nuevo cliente</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @if(!empty($customers))
                            @foreach($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{  URL::route('customer.edit', $customer->id) }}" title="Editar" class="btn btn-icon-only green-meadow ">
